...
curl -l "https://raw.githubusercontent.com/GLEECBTC/coins/${coins_repo_commit}/coins" --output "assets/coins.json"
curl -l "https://raw.githubusercontent.com/GLEECBTC/coins/${coins_repo_commit}/utils/coins_config_tcp.json" --output "assets/coins_config_tcp.json"
